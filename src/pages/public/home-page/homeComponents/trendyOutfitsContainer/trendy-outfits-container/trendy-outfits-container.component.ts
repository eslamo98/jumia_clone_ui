// trendy-outfits-container.component.ts
...
@Component({
  selector: 'app-trendy-outfits-container',
  imports: [CommonModule , RouterModule],
  templateUrl: './trendy-outfits-container.component.html',
  styleUrl: './trendy-outfits-container.component.css',
  standalone: true
})
export class TrendyOutfitsContainerComponent extends Helpers implements OnInit, AfterViewInit {
  ...
  loadProductsFromApi(): void {
    ...
    this.productService.getRandomCategoryProducts("Fashion").subscribe({
      next: (data) => {
