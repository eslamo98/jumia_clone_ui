...
export class TopSellingComponent extends Helpers implements OnInit, AfterViewInit {
  ...
  loadProductsFromApi(): void {
    ...
    this.productService.getRandomSubCategoryProducts("Women's Clothing").subscribe({
      next: (data) => {
