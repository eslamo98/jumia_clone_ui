// kitchen-container.component.ts
...
@Component({
  selector: 'app-kitchen-container',
  imports: [CommonModule , RouterModule],
  templateUrl: './kitchen-container.component.html',
  styleUrl: './kitchen-container.component.css',
  standalone: true
})
export class KitchenContainerComponent extends Helpers implements OnInit, AfterViewInit {
  ...
  loadProductsFromApi(): void {
    ...
    this.productService.getRandomCategoryProducts("Home & Kitchen").subscribe({
      next: (data) => {
