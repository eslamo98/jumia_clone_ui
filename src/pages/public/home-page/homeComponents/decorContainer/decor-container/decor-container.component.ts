...
@Component({
  selector: 'app-decor-container',
  imports: [CommonModule , RouterModule],
  templateUrl: './decor-container.component.html',
  styleUrl: './decor-container.component.css',
  standalone: true
})
export class DecorContainerComponent extends Helpers implements OnInit, AfterViewInit {
  ...
  loadProductsFromApi(): void {
    ...
    this.productService.getRandomSubCategoryProducts("Home Decor").subscribe({
      next: (data) => {
